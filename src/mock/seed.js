...
export const promotions = [
  {
    id: 'promo-1', name: '20% off Nike over $100', type: 'discount',
    ...
    gifts: [], performance: 87, revenue: '€24,500',
    createdBy: 'Anna K.', createdAt: '2026-03-18T10:00:00Z', updatedAt: '2026-03-18T10:00:00Z',
  },
  {
    id: 'promo-2', name: 'Flash Sale — Electronics', type: 'discount',
    value: '30', valueUnit: '%', steps: [], priority: 5, status: 'active',
    startDate: '2026-03-15', endDate: '2026-03-20', stackingGroupId: 'sg-1',
    conditions: [{ id: 'c3', field: 'categories', mode: 'include', values: ['Electronics'] }],
    gifts: [], performance: 62, revenue: '€12,300',
...
export const templates = [
  {
    id: 'tpl-1', label: 'Flash Sale — Electronics', description: 'Time-limited discount on electronics',
    ruleType: 'discount', defaultValue: '30', defaultValueUnit: '%',
    defaultConditions: [{ field: 'categories', mode: 'include', values: ['Electronics'] }],
  },
  {
    ...
    defaultConditions: [{ field: 'brands', mode: 'include', values: ['Nike'] }],
  },
  {
  ...
  {
    id: 'tpl-4', label: 'Free Gift', description: 'Gift item with minimum purchase',
